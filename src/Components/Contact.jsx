const socialLinks = [
  {
    href: "https://github.com/chyleangly",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  {
    href: "https://www.linkedin.com/in/chyleangly",
    icon: (
      <svg
        width="24"
        height="24"
  ...
  // },
  {
    href: "https://www.instagram.com/chiiluxx",
    icon: (
      <svg
        width="25"
        height="24"
...
const Contact = () => {
  return (
    <section id="contact" className="section mb-16">
      <div className="container lg:grid lg:grid-cols-2 lg:items-stretch">
        <div className="mb-12 lg:mb-0 lg:flex lg:flex-col">
          ...
          <p className="text-softSky-400 mt-3 mb-8 max-w-[50ch] lg:max-w-[30ch]">
          ...
          <div className="flex items-center gap-2 mt-auto">
            {socialLinks.map(({ href, icon }, key) => (
              <a
                ...
                href={href}
                target="_blank"
                className="w-12 h-12 grid place-items-center ring-2 ring-inset ring-softSky-50/5 rounded-lg transition-[background-color,color]
                hover:bg-softSky-50 hover:text-softSky-950 active:bg-softSky-50/80"
              >
                {icon}
              </a>
            ))}
          ...
          <div className="md:grid md:items-center md:grid-cols-2 md:gap-2">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                autoComplete="email"
                required
                placeholder="chyleang@example.com"
                className="text-field"
              />
            </div>
          </div>
